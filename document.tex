...
\newcommand{\examinerB}{Aaron Africa}
...
\newcommand{\groupID}{Kevin and Friends} % group ID number is for undergraduates as of this formatting

\newcommand{\numberOfAuthors}{5} % adapt the number of names below accordingly and sort the sunames in alphabetically ascending manner, like the given example

\defineAuthor{surname1}{Eco}
\defineAuthor{firstname1}{Lance Randall L.}

\defineAuthor{surname2}{Cepria}
\defineAuthor{firstname2}{Kevin Jeff T.}

\defineAuthor{surname3}{Liwag}
\defineAuthor{firstname3}{Ryan Joshua H.}

\defineAuthor{surname4}{Rapio}
\defineAuthor{firstname4}{Anfernee S.}



\newcommand{\documentTitle}{Development of Remote Controlled Bluetooth Mobile Robot with Live Video Feedback} % put tilde (~) between words to indicate non-breaking adjacent words
